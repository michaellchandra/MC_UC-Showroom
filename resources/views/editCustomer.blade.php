    ...
    <div class="container">
        ...
        <form action="/updatecustomer" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="nama" value="{{ old('nama', $customers->nama) }}" required><br>
            </div>

            <div class="mb-3">
                <label class="form-label" for="customer-address">Customer Address:</label>
                <input class="form-control" type="text" name="alamat" value="{{ old('alamat', $customer->nama) }}"required><br>
